...
const PopupCreate = ({ openAddPopup, setOpenAddPopup, onAddPopupCreated }) => {
  ...
  const onClick = async () => {
    try {
      const response = await axios.post('/popup', items);
      if (response.status === 201) {
        toast.success('Popup Added', {
          autoClose: 1500,
          onClose: () => {
            onAddPopupCreated(); // Trigger the refresh
      ...
      <div className="p-4">
        <div className="">
          ...
          <div className="right-inputs">
            <label>Popup Slider Image</label>
